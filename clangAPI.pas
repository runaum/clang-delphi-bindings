(*
    CLang API for Delphi
      > Author: Aleksey A. Naumov [alexey.naumov@gmail.com]
      > License: BSD
      > Delphi API Version: 0.1a
      > LibCLang C API Version: 3.3
*)
unit clangAPI;
...
{$DEFINE CLANG_DEBUG}                          // Only for debug w/ vLogs
{$DEFINE CLANG_TRACE}                          // Only for trace w/ vLogs
{$DEFINE CLANG_DYNAMIC_LINK}                   // Dynamic or Static linking of libclang library
{.$DEFINE CLANG_DLIBRARY}                       // Debug library (D-postfix)

// Modules
{$DEFINE CLANG_API_CXSTRING}                   // CXString.h
{$DEFINE CLANG_API_CXCOMPILATIONBASE}          // CXCompilationBase.h
{$DEFINE CLANG_API_INDEX}                      // Index.h
...
{$IFDEF MSWINDOWS}
  CLangLibraryExt = '.dll';
{$ENDIF}
  CLangLibrary = 'libclang' + CLangBuild + '-' + CLangVersion + '.' + CLangArch + CLangLibraryExt;
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_getCString = function(string_: CXString): PAnsiChar; cdecl;
{$ELSE}
  function clang_getCString(string_: CXString): PAnsiChar; cdecl; external CLangLibrary name 'clang_getCString';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_disposeString = procedure(string_: CXString); cdecl;
{$ELSE}
  procedure clang_disposeString(string_: CXString); cdecl; external CLangLibrary name 'clang_disposeString';
{$ENDIF}

{$ENDIF}
//*------------------------------------------------- END of CXString.h ------------------------------------------------*//

//*========================================= START of CXCompilationDatabase.h =========================================*//
{$IFDEF CLANG_API_CXCOMPILATIONBASE}
 ...
 *)
  //typedef enum  {
  //  CXCompilationDatabase_NoError = 0, // No error occured
  //  CXCompilationDatabase_CanNotLoadDatabase = 1 // Database can not be loaded
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompilationDatabase_fromDirectory = function(BuildDir: PAnsiChar; var ErrorCode: CXCompilationDatabase_Error): CXCompilationDatabase; cdecl;
{$ELSE}
  function clang_CompilationDatabase_fromDirectory(BuildDir: PAnsiChar; var ErrorCode: CXCompilationDatabase_Error): CXCompilationDatabase; cdecl; external CLangLibrary name 'clang_CompilationDatabase_fromDirectory';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompilationDatabase_dispose = procedure(unknown: CXCompilationDatabase); cdecl;
{$ELSE}
  procedure clang_CompilationDatabase_dispose(unknown: CXCompilationDatabase); cdecl; external CLangLibrary name 'clang_CompilationDatabase_dispose';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompilationDatabase_getCompileCommands = function(unknown: CXCompilationDatabase; CompleteFileName: PAnsiChar): CXCompileCommands; cdecl;
{$ELSE}
  function clang_CompilationDatabase_getCompileCommands(unknown: CXCompilationDatabase; CompleteFileName: PAnsiChar): CXCompileCommands; cdecl; external CLangLibrary name 'clang_CompilationDatabase_getCompileCommands';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompilationDatabase_getAllCompileCommands = function(unknown: CXCompilationDatabase): CXCompileCommands; cdecl;
{$ELSE}
  function clang_CompilationDatabase_getAllCompileCommands(unknown: CXCompilationDatabase): CXCompileCommands; cdecl; external CLangLibrary name 'clang_CompilationDatabase_getAllCompileCommands';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompileCommands_dispose = procedure(unknown: CXCompileCommands); cdecl;
{$ELSE}
  procedure clang_CompileCommands_dispose(unknown: CXCompileCommands); cdecl; external CLangLibrary name 'clang_CompileCommands_dispose';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompileCommands_getSize = function(unknown: CXCompileCommands): Cardinal; cdecl;
{$ELSE}
  function clang_CompileCommands_getSize(unknown: CXCompileCommands): Cardinal; cdecl; external CLangLibrary name 'clang_CompileCommands_getSize';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompileCommands_getCommand = function(unknown: CXCompileCommands; I: Cardinal): CXCompileCommand; cdecl;
{$ELSE}
  function clang_CompileCommands_getCommand(unknown: CXCompileCommands; I: Cardinal): CXCompileCommand; cdecl; external CLangLibrary name 'clang_CompileCommands_getCommand';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompileCommand_getDirectory = function(unknown: CXCompileCommand): CXString; cdecl;
{$ELSE}
  function clang_CompileCommand_getDirectory(unknown: CXCompileCommand): CXString; cdecl; external CLangLibrary name 'clang_CompileCommand_getDirectory';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompileCommand_getNumArgs = function(unknown: CXCompileCommand): Cardinal; cdecl;
{$ELSE}
  function clang_CompileCommand_getNumArgs(unknown: CXCompileCommand): Cardinal; cdecl; external CLangLibrary name 'clang_CompileCommand_getNumArgs';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_CompileCommand_getArg = function(unknown: CXCompileCommand; I: Cardinal): CXString; cdecl;
{$ELSE}
  function clang_CompileCommand_getArg(unknown: CXCompileCommand; I: Cardinal): CXString; cdecl; external CLangLibrary name 'clang_CompileCommand_getArg';
{$ENDIF}

{$ENDIF}
//*------------------------------------------ END of CXCompilationDatabase.h ------------------------------------------*//

//*================================================= START of Index.h =================================================*//
{$IFDEF CLANG_API_INDEX}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_createIndex = function(excludeDeclarationsFromPCH: Integer; displayDiagnostics: Integer): CXIndex; cdecl;
{$ELSE}
  function clang_createIndex(excludeDeclarationsFromPCH: Integer; displayDiagnostics: Integer): CXIndex; cdecl; external CLangLibrary name 'clang_createIndex';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_disposeIndex = procedure(index: CXIndex); cdecl;
{$ELSE}
  procedure clang_disposeIndex(index: CXIndex); cdecl; external CLangLibrary name 'clang_disposeIndex';
{$ENDIF}
  ...
  CXGlobalOptFlags = (
    ...
    CXGlobalOpt_ThreadBackgroundPriorityForAll =
      CXGlobalOpt_ThreadBackgroundPriorityForIndexing or
      CXGlobalOpt_ThreadBackgroundPriorityForEditing
  );
 ...
 *)
  ...
  //} CXFileUniqueID;
  CXFileUniqueID = packed record
    data: array [0..2] of Int64; {#WARNING!}
  end;
 ...
 *)
  ...
  //  unsigned int_data;
  //} CXSourceLocation;
  CXSourceLocation = packed record
...
{$ENDIF}
  ...
  CXTUResourceUsageEntry = packed record
...
(*
  ...
  *)
  ...
  //
  //} CXTUResourceUsage;
  CXTUResourceUsage = packed record
    data: Pointer;
    numEntries: Cardinal;
 ...
 *)
  ...
  //} CXComment;
  CXComment = packed record
    ASTNode: Pointer;
    //TranslationUnit: CXTranslationUnit; {#WARNING!}
  end;
 ...
 *)
  ...
  CXPlatformAvailability = packed record
    Platform_: CXString;
    Introduced: CXVersion;
    Deprecated_: CXVersion;
    Obsoleted: CXVersion;
    Unavailable: Integer;
    Message_: CXString;
  end;
 ...
 *)
  ...
  //  void *data[2];
  //} CXType;
  CXType = packed record
    kind: CXTypeKind;
	data: array [0..1] of Pointer; {#WARNING}
  end;
 ...
 *)
  ...
  //  void *ptr_data;
  //} CXToken;
  CXToken = packed record
    int_data: array [0..3] of Cardinal; {#WARNING!}
  	ptr_data: Pointer;
  end;
...
//} CXCompletionResult;
  CXCompletionResult = packed record
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXCompletionChunkKind; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXCompletionChunkKind; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
 ...
 *)
  ...
  //                                         unsigned chunk_number);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXCompletionString; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXCompletionString; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
//} CXCodeCompleteResults;
  CXCodeCompleteResults = packed record
 ...
 *)
  ...
  //                                            unsigned options);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXCodeCompleteResults; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXCodeCompleteResults; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXRemapping; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXRemapping; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
type
  ...
  CXCursorAndRangeVisitor = packed record
    context: Pointer;
	  {#TODO!}
  end;
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXResult; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXResult; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
//} CXIdxIncludedFileInfo;
  CXIdxIncludedFileInfo = packed record
    //hashLoc: CXIdxLoc; {#WARNING!}
    filename: PAnsiChar;
    //file_: CXFile; {#WARNING!}
    isImport: Integer;
    isAngled: Integer;
...
//} CXIdxImportedASTFileInfo;
  CXIdxImportedASTFileInfo = packed record
    //file_: CXFile; {#WARNING!}
    module: CXModule;
    //loc: CXIdxLoc; {#WARNING!}
    isImplicit: Integer;
  end;
...
//  CXCursor cursor;
//} CXIdxContainerInfo;
  CXIdxContainerInfo = packed record
    cursor: CXCursor;
  end;
...
//} CXIdxIBOutletCollectionAttrInfo;
  CXIdxIBOutletCollectionAttrInfo = packed record
    attrInfo: ^CXIdxAttrInfo;
    objcClass: ^CXIdxEntityInfo;
    classCursor: CXCursor;
    //classLoc: CXIdxLoc; {#WARNING!}
  end;
...
//} CXIdxObjCContainerDeclInfo;
  CXIdxObjCContainerDeclInfo = packed record
...
//  CXIdxLoc loc;
//} CXIdxBaseClassInfo;
  CXIdxBaseClassInfo = packed record
...
//} CXIdxObjCProtocolRefInfo;
  CXIdxObjCProtocolRefInfo = packed record
...
//} CXIdxObjCProtocolRefListInfo;
  CXIdxObjCProtocolRefListInfo = packed record
    protocols: ^CXIdxObjCProtocolRefInfo; {#WARNING!}
...
//} CXIdxObjCInterfaceDeclInfo;
  CXIdxObjCInterfaceDeclInfo = packed record
...
//} CXIdxObjCCategoryDeclInfo;
  CXIdxObjCCategoryDeclInfo = packed record
    containerInfo: ^CXIdxObjCContainerDeclInfo;
	objcClass: ^CXIdxEntityInfo;
	classCursor: CXCursor;
	classLoc: CXIdxLoc; 
...
//} CXIdxObjCPropertyDeclInfo;
  CXIdxObjCPropertyDeclInfo = packed record
    declInfo: ^CXIdxDeclInfo;
...
//} CXIdxCXXClassDeclInfo;
  CXIdxCXXClassDeclInfo = packed record
    declInfo: ^CXIdxDeclInfo;
	//bases? {$TODO}
	numBases: Cardinal;
  end;
...
//} CXIdxEntityRefInfo;
  CXIdxEntityRefInfo = packed record
...
//
//} IndexerCallbacks;
  IndexerCallbacks = packed record
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCContainerDeclInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCContainerDeclInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}

  //CINDEX_LINKAGE const CXIdxObjCInterfaceDeclInfo *
  //clang_index_getObjCInterfaceDeclInfo(const CXIdxDeclInfo *);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCInterfaceDeclInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCInterfaceDeclInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCCategoryDeclInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCCategoryDeclInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}

  //CINDEX_LINKAGE const CXIdxObjCProtocolRefListInfo *
  //clang_index_getObjCProtocolRefListInfo(const CXIdxDeclInfo *);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCProtocolRefListInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCProtocolRefListInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}

  //CINDEX_LINKAGE const CXIdxObjCPropertyDeclInfo *
  //clang_index_getObjCPropertyDeclInfo(const CXIdxDeclInfo *);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCPropertyDeclInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxObjCPropertyDeclInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}

  //CINDEX_LINKAGE const CXIdxIBOutletCollectionAttrInfo *
  //clang_index_getIBOutletCollectionAttrInfo(const CXIdxAttrInfo *);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxIBOutletCollectionAttrInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxIBOutletCollectionAttrInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}

  //CINDEX_LINKAGE const CXIdxCXXClassDeclInfo *
  //clang_index_getCXXClassDeclInfo(const CXIdxDeclInfo *);
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): ^CXIdxCXXClassDeclInfo; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): ^CXIdxCXXClassDeclInfo; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXIdxClientContainer; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXIdxClientContainer; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXIdxClientEntity; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXIdxClientEntity; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  T = function(unknown: CXCompileCommand; I: Cardinal): CXIndexAction; cdecl;
{$ELSE}
  function XXXX(unknown: CXCompileCommand; I: Cardinal): CXIndexAction; cdecl; external CLangLibrary name 'XXXX';
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
  Tclang_indexLoc_getCXSourceLocation = function(loc: CXIdxLoc): CXSourceLocation; cdecl;
{$ELSE}
  function clang_indexLoc_getCXSourceLocation(loc: CXIdxLoc): CXSourceLocation; cdecl; external CLangLibrary name 'clang_indexLoc_getCXSourceLocation';
{$ENDIF}
...
var
{$IFDEF CLANG_API_CXSTRING}
  clang_getCString: Tclang_getCString;
  clang_disposeString: Tclang_disposeString;
{$ENDIF}
{$IFDEF CLANG_API_CXCOMPILATIONBASE}
  clang_CompilationDatabase_fromDirectory: Tclang_CompilationDatabase_fromDirectory;
  clang_CompilationDatabase_dispose: Tclang_CompilationDatabase_dispose;
  clang_CompilationDatabase_getCompileCommands: Tclang_CompilationDatabase_getCompileCommands;
  clang_CompilationDatabase_getAllCompileCommands: Tclang_CompilationDatabase_getAllCompileCommands;
  clang_CompileCommands_dispose: Tclang_CompileCommands_dispose;
  clang_CompileCommands_getSize: Tclang_CompileCommands_getSize;
  clang_CompileCommands_getCommand: Tclang_CompileCommands_getCommand;
  clang_CompileCommand_getDirectory: Tclang_CompileCommand_getDirectory;
  clang_CompileCommand_getNumArgs: Tclang_CompileCommand_getNumArgs;
  clang_CompileCommand_getArg: Tclang_CompileCommand_getArg;
{$ENDIF}
{$IFDEF CLANG_API_INDEX}
  //
{$ENDIF}
...
function IsCLangLoaded: Boolean;
function LoadCLang: Boolean;
procedure UnloadCLang;
{$ENDIF}

implementation

procedure CLangTraceLog(const AMessage: String; ACRLF: Boolean = False); overload;
begin
{$IFDEF CLANG_TRACE}
  Log(AMessage, ACRLF);
{$ENDIF}
...
procedure CLangTraceLog(const AMessage: String; AArgs: array of const; ACRLF: Boolean = False); overload;
begin
{$IFDEF CLANG_TRACE}
...
procedure CLangDebugLog(const AMessage: String; ACRLF: Boolean = False); overload;
begin
{$IFDEF CLANG_DEBUG}
  Log(AMessage, ACRLF);
{$ENDIF}
...
procedure CLangDebugLog(const AMessage: String; AArgs: array of const; ACRLF: Boolean = False); overload;
begin
{$IFDEF CLANG_DEBUG}
  Log(AMessage, AArgs, ACRLF);
{$ENDIF}
...
{$IFDEF CLANG_DYNAMIC_LINK}
function BindCLang(ABind: Boolean = True): Boolean;
var
  BindResult: Boolean;

  function BindCLangProc(const AProcName: String; AAllowNotFound: Boolean = False): Pointer;
  begin
    if ABind then
    begin
      Result := GetProcAddress(hLibrary, PAnsiChar(AnsiString(AProcName)));
      CLangTraceLog('%s', [AProcName]);
      if (Result = nil) and (not AAllowNotFound) then
      begin
        CLangDebugLog('[-] Function "%s" not founded in LLVM Library!', [AProcName]);
        BindResult := False;
      end;
    end else
      Result := nil;
...
begin
  BindResult := True;
{$IFDEF CLANG_API_CXSTRING}
  CLangTraceLog(';CXString.h');
  @clang_getCString := BindCLangProc('clang_getCString');
  @clang_disposeString := BindCLangProc('clang_disposeString');
  CLangTraceLog('');
{$ENDIF}
{$IFDEF CLANG_API_CXCOMPILATIONBASE}
  CLangTraceLog(';CXCompilationBase.h');
  @clang_CompilationDatabase_fromDirectory := BindCLangProc('clang_CompilationDatabase_fromDirectory');
  @clang_CompilationDatabase_dispose := BindCLangProc('clang_CompilationDatabase_dispose');
  @clang_CompilationDatabase_getCompileCommands := BindCLangProc('clang_CompilationDatabase_getCompileCommands');
  @clang_CompilationDatabase_getAllCompileCommands := BindCLangProc('clang_CompilationDatabase_getAllCompileCommands');
  @clang_CompileCommands_dispose := BindCLangProc('clang_CompileCommands_dispose');
  @clang_CompileCommands_getSize := BindCLangProc('clang_CompileCommands_getSize');
  @clang_CompileCommands_getCommand := BindCLangProc('clang_CompileCommands_getCommand');
  @clang_CompileCommand_getDirectory := BindCLangProc('clang_CompileCommand_getDirectory');
  @clang_CompileCommand_getNumArgs := BindCLangProc('clang_CompileCommand_getNumArgs');
  @clang_CompileCommand_getArg := BindCLangProc('clang_CompileCommand_getArg');
  CLangTraceLog('');
{$ENDIF}
{$IFDEF CLANG_API_INDEX}
  CLangTraceLog(';Index.h');
  // ToDo
  CLangTraceLog('');
{$ENDIF}  
  Result := BindResult;
...
begin
  ...
  Result := False;
  hLibrary := LoadLibrary(CLangLibrary);
  if (hLibrary <> 0) then
  begin
    Result := BindCLang;
    if not Result then
    ...
    CLangDebugLog('Cannot load "%s" library!', [CLangLibrary])
end;

procedure UnloadCLang;
begin
  if IsCLangLoaded then
  begin
    BindCLang(False);
